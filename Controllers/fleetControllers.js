...
// const chartGetRequestController  = (req,res)=>{
...
//     res.render('chart',{countedBrands});
//       // pass the data from there.
...
const  LoginPostRequestController = async (req,res)=>{
  ...
  if (req.body.pageType == 'Sign Up') {
    ...
    let values = req.body;
          ...
          functions.checkPasswordAndEmail(userModel, UserModel, res, req, values);
      } else {
